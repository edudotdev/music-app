...
export const CardSong = ({
  ...
  return (
    <div className='relative group/play flex items-center gap-1 hover:bg-neutral-600/40 odd:bg-neutral-700/30 px-1'>
      ...
      <div className='relative rounded-md overflow-hidden min-w-[45px]'>
      ...
      <Link href={`/track/${id}`} className='group/text overflow-hidden'>
        <div className='bottom-0 px-2 py-2.5 flex flex-col truncate justify-between'>
