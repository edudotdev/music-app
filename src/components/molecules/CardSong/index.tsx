  ...
  return (
    <div className='relative group' onMouseLeave={() => setShowMenu(false)}>
      ...
      <div className='relative rounded-xl overflow-hidden'>
        <img src={image} width={400} height={400} className='w-full' alt={title} />
        <div className='h-14 relative overflow-hidden rounded-b-xl'>
          <img src={image} width={400} height={400} className='absolute h-[900px] saturate-150 -bottom-9 blur-2xl' alt={title} />
        </div>
