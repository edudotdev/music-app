...
export const Nav = () => {
  ...
  return (
    <div className='flex flex-col gap-8 py-10 bg-neutral-900/60 bg-opacity-50 min-w-[260px] w-[260px] h-screen sticky top-0 before:block before:absolute before:w-5 before:h-5 before:rounded-full before:left-0 before:-top-10 before:bg-blue-500 before:shadow-before-nav lg:z-30'>
      <Logo />
      <Search />
